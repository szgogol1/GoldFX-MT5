...
if not exist "%SRC%\Indicators\GoldFX_BasisPro\GoldFX_BasisPro_Spread.mq4" (
  echo [ERROR] Cannot find Indicators\GoldFX_BasisPro\GoldFX_BasisPro_Spread.mq4
  echo Tried: %SRC%
  pause
  exit /b 1
)
...
echo   GoldFX_BasisPro_Overlay.mq4
echo   GoldFX_BasisPro_Spread.mq4
echo.
echo Usage: Open spot chart (XAUUSD.s) M15, drag BOTH indicators.
echo Set InpFutSymbol=GC (or your broker futures symbol).
pause
endlocal
